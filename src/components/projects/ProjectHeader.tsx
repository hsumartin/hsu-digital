...
export default function ProjectHeader({ eyebrow, title, subtitle, lead, tags }: ProjectHeaderProps) {
  return (
    <header className="relative pt-24 pb-[3.25rem] border-b border-stone-100 overflow-hidden">
      ...
      <div className="relative z-10 max-w-[88rem] mx-auto px-[clamp(1.5rem,4vw,4rem)]">
        <div className="font-mono text-[0.66rem] tracking-[0.16em] uppercase text-stone-400 mb-6">
          <b className="text-gold-600 font-medium">Projekt</b> · {eyebrow}
        </div>

        <SectionLabel num="01">Projektdetail</SectionLabel>

        <div className="grid grid-cols-[minmax(0,1.42fr)_minmax(18rem,0.8fr)] gap-12 items-end max-[860px]:grid-cols-1 max-[860px]:gap-6">
          <div>
