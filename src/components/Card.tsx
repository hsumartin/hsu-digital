...
export default function Card({
  ...
  `}
    >
      {/* === Headerbereich === */}
      <div
        className={`relative ${headerHeight} flex flex-col items-center justify-end text-center px-5 pt-10 pb-6`}
      >
        ...
        <div className="absolute inset-0 bg-gradient-to-t from-navy-900/85 via-navy-800/50 to-transparent" />
