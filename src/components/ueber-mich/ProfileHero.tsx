  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col justify-center px-[clamp(2rem,5vw,5rem)] py-[clamp(3rem,6vw,6rem)] max-[900px]:px-[clamp(1.5rem,6vw,4rem)] max-[900px]:pt-10">
        ...
        <h1 className="font-serif font-normal text-[clamp(2.4rem,4.5vw,4rem)] leading-[1.05] tracking-[-0.025em] text-ink max-w-[14ch]">
          Architect of{' '}
          <em className="italic text-gold-500">Systems and Thinking</em>
        </h1>
